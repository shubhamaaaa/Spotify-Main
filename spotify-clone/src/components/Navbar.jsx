    ...
    <>
      <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
         ...
         <p className='bg-black py-1 px-3 rounded-2xl text=[15px] cursor-pointer'>Shubham App</p>
         <p className='bg-purple-500 text-black w-7 h-7 flex items-center justify-center rounded-full'>S</p>
        </div>
