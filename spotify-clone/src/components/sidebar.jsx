  ...
  return (
    <div className='w-[25%] p-2 h-full flex-col gap-2 text-white hidden lg:flex'>
        ...
        <div className='bg-[#121212] h-[85%] rounded'>
            ...
            <div className='p-2 bg-[#242424] m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4'>
             <h1>Let's findsome podcasts to follow</h1>
             <p className='font-light'>we'll keep updates on new episodes</p>
